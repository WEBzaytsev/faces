    ...
    <div class="transition blogger">
        <div class="pos-r transition blogger__inner">
            <div class="pos-r z-2 blogger__inner_top">
                <span class="pos-a z-2 ws-nowrap text-18 sm-text-14 sm-line-height-16 line-height-21 absolute-center-x opacity-0 z--100 blogger__inner_btn"
...
endwhile; ?>
    ...
    <div class="grid-col-full-w">
        <a href="#"
           class="font-tenor width-fit-content mx-auto ws-nowrap transition block pos-r line-height-1 text-40 md-text-25 more-btn"><?php esc_html_e('Больше блогеров', 'faces'); ?></a>
    </div>
<?php endif; ?>
<?php else : ?>
